...
const ExternalPurchaseOperationSchema = new mongoose_1.Schema({
    operationId: { type: String, required: true, immutable: true, trim: true },
    userId: { type: String, required: true, immutable: true },
    shopItemId: { type: mongoose_1.Schema.Types.ObjectId, required: true, immutable: true, ref: 'ShopItem' },
...
exports.default = mongoose_1.default.model('ExternalPurchaseOperation', ExternalPurchaseOperationSchema);
